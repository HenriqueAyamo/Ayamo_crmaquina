    ...
    <div className="mb-6 flex items-start justify-between">
      ...
      {actionLabel && (
        <button
          type="button"
          onClick={onAction}
          className="flex items-center gap-2 rounded bg-ayamo-primary px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:-translate-y-px hover:shadow-card-hover hover:opacity-95 active:translate-y-0"
        >
